...
EnvItem Map::CreateEnvItem(char c, float line,float col)
{
    ...
    switch (c)
    {
        case 'a':
            ...
            break;
        case 'd':
            newEnvItem = { { col * 100, -800 + (line * 100), 100, 100 }, {1,1,1,1}, BLACK, EnvItemType::dirt };
            break;
        case 'b':
            newEnvItem = { { col * 100, -800 + (line * 100), 100, 100 }, {1,1,1,1}, BLACK, EnvItemType::brick };
            break;
        case 'c':
            newEnvItem = { { col * 100, -800 + (line * 100), 100, 100 }, {1,1,1,1}, BLACK, EnvItemType::classic };
            break;
        case 't':
            newEnvItem = { { col * 100, -800 + (line * 100), 100, 100 }, {1,1,1,1}, BLACK, EnvItemType::surprise };
            break;
        case 'p':
            newEnvItem = { { col * 100, -800 + (line * 100), 100, 100 }, {1,1,1,1}, BLACK, EnvItemType::pipe };
            break;
        case 'q':
            newEnvItem = { { col * 100, -800 + (line * 100), 100, 100 }, {1,1,1,1}, BLACK, EnvItemType::pipeB };
            break;
        case 's':
